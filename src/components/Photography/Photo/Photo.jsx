...
export const Photo = () => {
    ...
    const grid = [
        ...
        { id : 1 , src : '/assets/img/P1085588.jpg' , alt : 'Img' , big : ''},
        { id : 2 , src : '/assets/UBINAS/DJI_0021.jpg' , alt : 'Img' , big : ''},
        { id : 3 , src : '/assets/UBINAS/DJI_0025.jpg' , alt : 'Img' , big : ''},
        { id : 4 , src : '/assets/img/DJI_0027-Editar.jpg' , alt : 'Img' , big : ''},
        { id : 5 , src : '/assets/UBINAS/DJI_0005.jpg' , alt : 'Img' , big : ''},
        { id : 6 , src : '/assets/UBINAS/DJI_0049.jpg' , alt : 'Img' , big : ''},
        { id : 7 , src : '/assets/UBINAS/DJI_0056-2.jpg' , alt : 'Img' , big : 'Big'},
